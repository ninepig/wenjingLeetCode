...
/*
 *   author :wenjing yang 
 * usage : for symantec interview online test 
 ...
 * i used eclipse to do the test , the input was your testcase file(i put them in the args string[])
 * i just print the output to the console
 * then output  the console result into output2.txt
 * 
 */

public class SymantecInterViewQuestionSolution {
